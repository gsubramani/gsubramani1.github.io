...
"""Library of constraint types. The constraint equations Phi_mat and the non-kinematic parameterization constraints non_kin(such as quaternion normalization) are implemented for each constraint type. """
...
if __name__ == "__main__":
    pc = concentric_cylinder_constraint()
